                ...
                <div class="col-md-11 mx-auto">
                    ...
                    <div class="card ">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <div class="d-sm-flex">
                                <h2 class="h3 mb-0 text-gray-800">Edit Place</h2>
                            </div>
                            <router-link :to="{name: 'PlacesIndex'}" class="btn btn-primary w-10">Back</router-link>
                        </div>

                        <div class="card-body table-wrap">
                            <form @submit.prevent="updatePlace" class="row">
                                ...
                                <div class="col">
                                    ...
                                    <div class="row mb-3">
                                        <label for="stars" class="col-md-4 col-form-label text-md-end">Stars</label>
                                        <div class="col-md-6">
                                            <input id="stars" v-model="form.stars" type="number" min="1" max="5" step="1"  class="form-control" name="stars" required autocomplete="new-stars">
                                                <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <textarea style="height: 200px;" id="description" v-model="form.description" type="text" class="form-control" name="description" onload='this.style.height = "";this.style.height = this.scrollHeight + "px"'> </textarea>
                                                <span class="invalid-feedback" role="alert">
        ...
        methods: {
            ...
            addActivity() {
                ...
                if( result ){
                    ...
                    axios.post("/api/places/add/activity/", {
            ...
            removeActivity(activity) {
                ...
                axios.post("/api/places/remove/activity/", {
            ...
            getPlace() {
                axios.get("/api/places/"+  this.$route.params.id)
                .then(res => {
            ...
            updatePlace() {
                if(this.form.image == null){
                    axios.put("/api/places/" +this.$route.params.id, {
                        'name' : this.form.name,

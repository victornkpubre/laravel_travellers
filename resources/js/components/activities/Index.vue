                    ...
                    <div class="col">
                        <form action="">
                            <div class="row form-row ">
                                ...
                                <div class="col">
                                    <div @click="getActivities()" class="btn btn-primary mb-2" >Search</div>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="card-body table-wrap">
                ...
                <table class="table">
                    ...
                    <tr v-for="activity in activities" :key="activity.id">
                        ...
                        <td>
                            <router-link
                                :to="{name: 'ActivitiesEdit', params: {id: activity.id}}"
                                class="btn btn-primary float-right">
                                Edit
                            </router-link>
                        </td>
                        <td>
                            <button class="btn btn-danger" @click="deleteFestival(activity.id)" > Delete </button>
                        </td>
                    </tr>
                    </tbody>
                </table>

                ...
                <div class="col-md-11 mx-auto">
                    ...
                    <div class="card ">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <div class="d-sm-flex">
                                <h2 class="h3 mb-0 text-gray-800">Edit Booking</h2>
                            </div>
                            <router-link :to="{name: 'BookingsIndex'}" class="btn btn-primary w-10">Back</router-link>
                        </div>

                        <div class="card-body table-wrap">
                            <form @submit.prevent="updateBooking" class="row">
                                ...
                                <div class="col col-md-6">
                                    <label for="client" class="col-md-12 col-form-label text-md-start">Client: {{ form.client.first_name + " " + form.client.last_name }} </label>
                                    <div class="row mb-3">
                                        <div class="col-md-12">
                                            <select name="client" v-model="form.client" class="form-select form-control" aria-label="Default select example">
                                                <option v-for="client in clients" :key="client.id" :value="client" > {{ client.first_name + " " + client.last_name }} </option>
                                            </select>
                                        </div>
                                    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            getBookings(){
                axios.get("/api/bookings/"+  this.$route.params.id)
                .then(res => {
            ...
            updateBooking(){
                axios.put("/api/bookings/"+this.$route.params.id,  {
